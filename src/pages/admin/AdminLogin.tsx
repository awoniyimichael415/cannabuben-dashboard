...
const AdminLogin: React.FC = () => {
  ...
  return (
    <div style={{ minHeight: "100dvh", display: "grid", placeItems: "center", background: "#FAF6EC", padding: "env(safe-area-inset-top) 16px env(safe-area-inset-bottom)" }}>
      <form onSubmit={submit} style={{ width: 360, background: "#fff", padding: 24, borderRadius: 12, boxShadow: "0 6px 24px rgba(0,0,0,0.08)" }}>
        ...
        <button type="submit" style={{ width: "100%", padding: 12, background: "#2E5632", color: "#fff", border: "none", borderRadius: 8, fontWeight: 700 }}>
          Sign in
        </button>
      </form>
    </div>
