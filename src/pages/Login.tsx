...
import "../styles/dashboard.css"; // ✅ include shared styling
import logo from "../assets/logo.png"; // ✅ use your real logo
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 style={{ marginBottom: 8, color: "#2E5632" }}>
